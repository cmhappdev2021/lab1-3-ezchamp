...
print(addedHRD)
print(averageHRD)
print("The average answer technically does differ from the previous average because it doesn't truncate the decimal; however, my chosen values resulted in the same average mathematically.")
...
let heartbeatRate:Double = 82
let heartbeatRate2:Double = 68
let heartbeatRate3:Double = 74
let averageHeartBeatRate = (heartbeatRate + heartbeatRate2 + heartbeatRate3) / 3
print(averageHeartBeatRate)
